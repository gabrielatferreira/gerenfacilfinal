        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (enteredUsername.isEmpty() || enteredPassword.isEmpty()) {
                    ...
                    nome = pref.getString("chNome", "thiago");
                    email = pref.getString("chEmail", "thiago@gmail.com");
                    user = pref.getString("chCPF_CNPJ", "00951049097");
                    pass = pref.getString("chPass", "123456");
